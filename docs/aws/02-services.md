...
静的ファイルをAWSで公開する前に、使うサービスと構成の違いを確認します。

目安: 15分

分からない用語が出てきたら[用語集：S3単体公開](terms-03-s3.md)を参照してください。
...
分からない用語が出てきたら [用語集：S3 + CloudFront公開](terms-04-cloudfront.md) を参照してください。
